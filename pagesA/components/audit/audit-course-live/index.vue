...
<template>
	<view class="list-item" @click="gotoCourseVideo(dataInfo,index)">
		<view class="item-top">
			<image
				:class="{head2:dataInfo.unlock.unlockType!=9 && dataInfo.unlock.isUnLock == 0,head:dataInfo.isAudition!=1}"
			...
			<image class="play" v-else :src="imageUrl+'/static/learn/homeLive/功能.png'"></image>
			...
			<!-- <view class="div">
				<image class="image" :src="imageUrl+'/static/learn/homeLive/直播.png'" mode=""></image>
				<view class="zhib">
					直播
				</view>
			</view> -->
