		...
		methods: {
			...
			submit() {
				...
				uni.navigateTo({
					...
					url: `/pagesB/parsing/index_tourist?sourceType=${this.sourceType}&couti=${cuoti}&num_tixing=${this.num_tixing.join(',')}&num_fenlei=${this.num_fenlei}&sourType=${this.sourType}`
				})
			},
			onQestions(item, index, zindex) {
				...
				uni.navigateTo({
					url: '/pagesB/parsing/index_tourist?sourceType=' + this.sourceType + '&couti=' + cuoti +
