...
<script>
	import judgment from "./commpoents/judgment.vue" //判断题
	import Answerse from "./commpoents/Answer.vue" //解答题
	...
	export default {
		...
		methods: {
			...
			onCommontopic(item, index, value, xia) {
				...
				if (this.topicList.questionPaperSubjectSubordinatesList[0].successNumber > 1) {
					...
					if (item.Hasa) {
						...
						this.$set(this.topicList.questionPaperSubjectSubordinatesList[0].questionPaperOption[index],
							'Hasa', true)
						this.$forceUpdate()
					}
					console.log(this.lists)
						...
						if (this.lists.isAss != 0) {
							if (this.ListType == 5) {
								...
								if (this.topicList.questionChapterPractice.optionId.split(',').length > 1) {
									...
									this.topicList.questionPaperOption.forEach((res, index) => {
										if (res.id == this.topicList.questionChapterPractice.optionId) {
											console.log(res, 90)
											if (this.ListType == 1) {
			...
			async SubjectList(value) {
				...
				if (this.listArr[this.type].type == 3 || this.listArr[this.type].type == 4 || this.listArr[this.type].type == 10) {
