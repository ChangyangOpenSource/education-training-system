<template>
	<div class="charts">
		<view class="charts-box">
			<qiun-data-charts type="demotype" :opts="opts" :chartData="data" @getIndex="funA()" />
		</view>
	</div>
</template>
	...
	export default {
		...
		data() {
			return {
				...
				opts: {
					color: ["#F1592A", "#91CB74", "#FAC858"], // 每条折线的颜色
					padding: [10, 0, 5, 0], // 填充边距
					...
					xAxis: { scrollShow: true, itemCount: 5, disableGrid: true },
					extra: {
						tooltip: {
							showCategory: false,
							// bgColor:#0491a3,
