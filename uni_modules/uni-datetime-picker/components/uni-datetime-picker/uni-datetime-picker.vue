<template>
	...
	export default {
		...
		methods: {
			...
			close() {
				console.log(123,this.singleVal)
				setTimeout(() => {
					this.popup = false
			...
			confirmRangeChange() {
				...
				if (!this.hasTime) {
					...
					console.log(this.range.startDate,1 )
					console.log(this.range.endDate ,1)
				} else {
					start = this.range.startDate = this.tempRange.startDate + ' ' +
